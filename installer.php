...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'commercecore_task_5b45331cf4819e222749_20230305145749_archive.zip';
        const ARCHIVE_SIZE       = '30576012';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '5b45331-05145749';
        const SECONDARY_PACKAGE_HASH = '95816a0-05145749';
